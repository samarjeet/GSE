...
template <>
__global__ void reduce_force<long long int, float>(const int n,
						   const int stride_in,
...
template <>
__global__ void reduce_force<long long int, double>(const int n,
						    const int stride_in,
						    const long long int* __restrict__ data_in,
						    const int stride_out,
...
// Convert "long long int" -> "float"
template <>
__global__ void reduce_force<long long int, float>(const int nfft_tot,
						   const long long int* __restrict__ data_in,
						   float* __restrict__ data_out) {
  unsigned int pos = blockIdx.x*blockDim.x + threadIdx.x;
...
template <>
__global__ void reduce_add_force<long long int, double, float>(const int nfft_tot,
